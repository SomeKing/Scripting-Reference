...
#Command used to find and get mail as an object in powershell
<#
Add-type -assembly “Microsoft.Office.Interop.Outlook” | out-null
$outlook = new-object -comobject outlook.application
$namespace = $outlook.GetNameSpace(“MAPI”)

$namespace.Folders.Item(5).Folders.Item(28).Folders.Item(4).items | Where -Property Subject -eq 'Firewall is Down at least 2 min (Vaga - Firewall).' | Select-Object -Property Subject, ReceivedTime, Importance, SenderName
#> 
